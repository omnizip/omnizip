...
module Omnizip
  module Formats
    module Rar3
      # RAR v3 compressor
      #
      # Compresses data using RAR v3 compression algorithms.
      # This implementation uses DEFLATE as a compatible fallback
      # for demonstration purposes. Full RAR compression requires
      # proprietary algorithms.
      #
      # @example Compressing data
      #   compressor = Rar3::Compressor.new
      #   compressed = compressor.compress("Hello, World!", method: :normal)
      class Compressor < Rar::RarFormatBase
        # Initialize a RAR v3 compressor
        def initialize
          super("rar3")
        end

        # Compress data using RAR v3 methods
        #
