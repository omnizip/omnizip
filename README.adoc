...
Everywhere else — including JRuby/TruffleRuby and any platform without
a binary — the gem stays fully functional on its pure-Ruby core (the
acceleration is strictly optional). Three escape hatches:
